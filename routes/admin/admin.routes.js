...
const {registerAdmin, loginAdmin, getAllUsersList, searchUser, changeAdminPassword, getAffiliateTree,editAnyUser, deleteAnyUser, authenticationApiAdmin} = require('../../controllers/admin/web/admin.web.controllers.js');
